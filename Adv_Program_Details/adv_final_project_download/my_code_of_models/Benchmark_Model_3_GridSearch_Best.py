...
if __name__ == '__main__':
    ...
    X_train=ch2.fit_transform(X_train_,y_train_)
    # print('shape of vocabulary after chi2 is {}'.format(len(X_train[0])))


    X_test_=vectorizer.transform(newsgroups_test.data)
    X_test=ch2.transform(X_test_)

    print('... ... ... ... chi2 end ... ... ... ... ' )

    print('... ... ... ... start building logistic regression model ... ... ... ...')
    lr = LogisticRegression(C=10, class_weight=None, dual=False, fit_intercept=True,intercept_scaling=1, max_iter=8, multi_class='ovr', n_jobs=-1,penalty='l2', random_state=18, solver='sag', tol=0.0001,verbose=0, warm_start=False)
    ...
    print("Best LR model after GridSearch has accuracy score {:,.2f} on test data".format(score))
