...
if __name__ == '__main__':
    ...
    print('start to load googlenews bin!!!')
    model = gensim.models.KeyedVectors.load_word2vec_format('w2v_model/GoogleNews-vectors-negative300.bin',binary=True)
    print(model['school'])
    print('googlenews model trained!!!')
    ...
    checkpointer = ModelCheckpoint(filepath='./saved_cnn_models/weights.best.textcnn_adadelta_google.hdf5', 
    ...
    my_cnn_model.load_weights('./saved_cnn_models/weights.best.textcnn_adadelta_google.hdf5')
    ...
    print("TextCNN model with GoogleNews vectors has accuracy score {:,.2f} on test data".format(score_solution2))
